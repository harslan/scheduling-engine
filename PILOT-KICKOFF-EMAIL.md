...
Three things matter here. It's transparent: everyone sees the rule and their own result. It's consensual: no one is moved without saying yes. And it stays in your hands, because the system won't make a single assignment official until the faculty have voted to adopt the rule. Until then, every run is only a simulation.

I'll admit the moment it became real for me. This kind of fair-assignment problem is what I've spent my career on, so I was ready to distrust our own tool. We fed it this past spring's actual teaching schedule, all 120 faculty, under made-up names to protect privacy, and it landed on the same answer our hand analysis did: 61 offices needed, 60 available, short by one, and it named who. The math and the software agreed.
